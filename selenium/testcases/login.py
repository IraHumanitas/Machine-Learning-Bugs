...
def run_login_test(driver, url, test_cases):
    driver.get(url)
    results = []
    ...
    for case in test_cases:
        ...
        log_details = {
            ...
            "details": {
                ...
                "expected_error_message": expected_value,
    ...
    save_test_result("login", results)
    driver.quit()
...
def run_tests(url, test_cases):
    ...
    try:
        run_login_test(driver, url, test_cases)
    finally:
        driver.quit()
